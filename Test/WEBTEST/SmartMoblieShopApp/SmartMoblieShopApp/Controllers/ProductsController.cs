...
namespace SmartMoblieShopApp.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(SmartMobileShopContext context)
        {
            _context = context;
        }
        ...
        {
            var smartMobileShopContext = _context.Product.Include(p => p.Category);
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductName,CategoryId,Price,Description,Photo")] Product product)
        {
